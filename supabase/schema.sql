...
-- NO editar a mano. Es el resultado de aplicar 6 migraciones
-- (0001_initial_schema.sql … 0006_exams_school_canonical.sql) en orden; sirve para entornos NUEVOS y para
-- leer el esquema real. Los entornos existentes NO se tocan con este archivo:
-- se migran aplicando 0002…0006_exams_school_canonical.sql en orden tras la 0001 congelada
